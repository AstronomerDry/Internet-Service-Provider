...
{               ?>
                        ...
                        <?php if(isset($_SESSION['ispmsuid']) && !empty($_SESSION['ispmsuid'])) { ?>
                        <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><?php
                        // Retrieve and display the phone number of the logged-in user
                        $user_id = $_SESSION['ispmsuid'];
                        $sql = "SELECT MobileNumber FROM tbluser WHERE ID = :user_id";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':user_id', $user_id, PDO::PARAM_INT);
                        $query->execute();
                        $user = $query->fetch(PDO::FETCH_ASSOC);
                        echo "+".htmlentities($user['MobileNumber']);
                        ?>
                        </li>
                        <?php } ?>
                        <?php $cnt=$cnt+1;}} ?>
                ...
                <div class="logo-nav-left1">
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            ...
                            <li class="agileits dropdown <?php if($current_page == "about.php") echo 'active'; ?>"><a href="about.php">About</a></li>
                            <li class="<?php if($current_page == "bbplan.php") echo 'active'; ?>"><a href="bbplan.php">Broadband</a></li>
                            <li class="<?php if($current_page == "dthplan.php") echo 'active'; ?>"><a href="dthplan.php">Digital Cable TV</a></li>
                            <li class="<?php if($current_page == "contact.php") echo 'active'; ?>"><a href="contact.php">contact us</a></li>
                            <?php if (strlen($_SESSION['ispmsuid']!=0)) {?>
                                    <li class="agileits dropdown <?php if($current_page == "profile.php" || $current_page == "change-password.php" || $current_page == "logout.php") echo 'active'; ?>">
                                    ...
                                    <li class="agileits dropdown <?php if($current_page == "broadband-request.php" || $current_page == "dth-request.php") echo 'active'; ?>">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <div class="login-form">
                                            <form method="post" name="signup" onsubmit="return checkpass();">
                                                ...
                                                <input type="password" name="confirm_password" placeholder="Confirm Password" required="true" id="password2">
